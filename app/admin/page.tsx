        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <form onSubmit={crearEmpleado} className="space-y-4">
              <input type="text" placeholder="Nombre Completo" value={nombre} onChange={e => setNombre(e.target.value)} className="w-full bg-slate-800 p-3 rounded-lg border border-slate-700 outline-none focus:border-blue-500" required />
              <input type="text" placeholder="Cédula (Contraseña)" value={cedula} onChange={e => setCedula(e.target.value)} className="w-full bg-slate-800 p-3 rounded-lg border border-slate-700 outline-none focus:border-blue-500" required />
              <input type="email" placeholder="Correo Electrónico" value={email} onChange={e => setEmail(e.target.value)} className="w-full bg-slate-800 p-3 rounded-lg border border-slate-700 outline-none focus:border-blue-500" required />
              <input type="text" placeholder="PIN Seguridad" value={pin} onChange={e => setPin(e.target.value)} className="w-full bg-slate-800 p-3 rounded-lg border border-slate-700 outline-none focus:border-blue-500" required />
              ...
              <button disabled={cargando} className="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded-lg font-bold transition-all">
                {cargando ? 'Procesando...' : 'Registrar Empleado'}
              </button>
            </form>
