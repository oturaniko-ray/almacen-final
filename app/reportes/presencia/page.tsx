...
export default function PresenciaPage() {
  ...
  const exportarAsistencia = () => {
    ...
    const content = [`Reporte de Asistencia a las: ${ahora.toLocaleTimeString()}`, `Exportado por: ${user?.nombre} - ${getRolDisplay(user?.rol)}`, "", encabezados, ...filas].join("\n");
  ...
  return (
    <main className="min-h-screen bg-black flex flex-col font-sans overflow-hidden">
      ...
      <div className="p-4 bg-[#1a1a1a] border-t border-white/5 flex justify-between items-center px-10">
        ...
        {/* CORRECCIÓN: Ahora redirige al submenú de reportes */}
